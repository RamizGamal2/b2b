...
export default function Sidebar() {
  ...
  return <>
    ...
    <div className=' d-flex flex-column'>
      ...
      <nav className="navbar navbar-light navbar-expand-lg   mx-4   m-2 ">
        <div className="container-fluid  d-flex flex-sm-row flex-lg-column flex-row flex-md-row flex-xl-column min-vh-lg-100    align-items-start p-0  ">
          ...
          <Link className='text-white text-decoration-none  d-flex justify-content-center ' role='button' href="/">
      ...
      <div className='  position-relative m-4   ps-4 pe-4  d-lg-flex d-sm-none d-none'>
        ...
        <Image src={helpIcon} alt='help' width={35} height={35} className=' position-absolute' style={{ top: '10px', right: '40px' }} />
